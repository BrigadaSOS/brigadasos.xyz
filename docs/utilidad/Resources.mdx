...
:::tip Consejo
Para aprender vocabulario, el camino que recomendamos aquí es hacer los mazos Tango N5 y N4 con Anki, para posteriormente aprender vocabulario a través de la inmersión que realice. Consulte **[Inmersión](../guia-principal/Immersion.mdx)** y **[Anki](../configuracion/Anki.mdx)** para más información.
:::
...
- [Jimaku](https://jimaku.cc/) - Página para encontrar subtitulos de anime y live action, posiblemente la mejor página para encontrar subtitulos.
